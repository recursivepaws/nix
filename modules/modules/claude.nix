{ inputs, ... }:
{
  flake-file.inputs.claude-plugins-nix.url = "github:mreimbold/claude-plugins-nix";
  ...
  den.aspects.claude = {
    homeManager =
      ...
      in
      {
        ...
        home.activation.installClaudePlugins = lib.mkForce (lib.hm.dag.entryAfter [ "writeBoundary" ] ''
